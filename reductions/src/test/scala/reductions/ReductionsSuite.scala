...
class ReductionsSuite extends munit.FunSuite:
	...
	def PBCheck(str: String, want: Boolean, thresh: Int = 1): Unit =
		assert(parBalance(str.toCharArray, thresh) == want, s"\"$str\" should be ${want.toString.toUpperCase}")
